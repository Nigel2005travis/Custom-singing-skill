...
class SingingSkill(MycroftSkill):
    def __init__(self):
        ...
        self.process = None
        self.play_list = {
            0: join(dirname(__file__), "enemy.mp3"),
            1: join(dirname(__file__), "justtheway.mp3"),
            2: join(dirname(__file__), "thinking.mp3"),
            3: join(dirname(__file__), "perfect.mp3"),
            4: join(dirname(__file__), "allofme.mp3"),
            5: join(dirname(__file__), "badlier.mp3"),
            6: join(dirname(__file__), "believer.mp3"),
        }
